...
VALUES (8,
        ...
        false,
        12,
        '[{"ruleactions": {"tasks": ["clearancesale", "yearendsale"], "properties": {"shipby": "ups", "nextstep": "coupondistribution"}}, "rulepattern": [{"op": "eq", "val": "2", "attr": "inventoryqty"}, {"op": "eq", "val": "200", "attr": "mrp"}]}, {"ruleactions": {"tasks": ["diwalisale"], "properties": {"shipby": "ups", "nextstep": "coupondistribution"}}, "rulepattern": [{"op": "eq", "val": "demo", "attr": "cat"}]}, {"ruleactions": {"tasks": ["newyearsale"], "properties": {"shipby": "ups", "nextstep": "coupondistribution"}}, "rulepattern": [{"op": "eq", "val": "belampally", "attr": "fullname"}, {"op": "eq", "val": "200", "attr": "mrp"}]}]',
        '2024-01-28T00:00:00Z',
        'admin',
        '2024-01-15T00:00:00Z',
        'admin');
