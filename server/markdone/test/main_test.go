...
func registerRoutes(databaseUrl string) (*gin.Engine, error) {
	...
	queries.AddWFNewInstances(context.Background(), sqlc.AddWFNewInstancesParams{
		Entityid: Entityid,
		Slice:    Slice,
		App:      App,
		Class:    Class,
	...
	s.RegisterRoute(http.MethodPost, "/wFinstancemarkdone", markdone.WFInstanceMarkDone)
	return r, nil
